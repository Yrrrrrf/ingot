#!/usr/bin/env python3
"""
Showcase of the refactored ingot library with all features demonstrated.
...
def main():
    ...
    if current_tab:
        scene_view = (
            current_tab.widget()
        )  # This is the SceneView wrapped in QScrollArea
    ...
    print("ingot Feature Showcase launched!")
