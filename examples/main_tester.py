#!/usr/bin/env python3
"""
Simplified main tester for the refactored ingot library.
...
def main():
    ...
    config = {"title": "ingot Main Tester"}
    ...
    if current_tab:
        ...
        if hasattr(scene_view, "get_scene_manager"):
            ...
            scene_manager.add_item(
                Text(
                    "Main Tester", x=200, y=350, color=QColor(255, 255, 0), font_size=18
                )
            )

    print("ingot Main Tester launched!")
