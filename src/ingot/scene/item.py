...
class RectangleItem(SceneItem):
    ...
    def get_center_position(self) -> QPointF:
        ...
        """
        return QPointF(
            self._pos.x() + self._width / 2, self._pos.y() + self._height / 2
        )
    ...
    def contains_point(self, point: QPointF) -> bool:
        ...
        """
        return (
            self._pos.x() <= point.x() <= self._pos.x() + self._width
            and self._pos.y() <= point.y() <= self._pos.y() + self._height
        )
...
class TextItem(SceneItem):
    ...
    def contains_point(self, point: QPointF) -> bool:
        ...
        return (
            self._pos.x() <= point.x() <= self._pos.x() + 100
            and self._pos.y() <= point.y() <= self._pos.y() + 20
        )
